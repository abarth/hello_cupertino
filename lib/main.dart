            ...
            onPressed: () {
              showDialog(
                ...
                child: new CupertinoAlertDialog(
                  title: new Text(
                      'Allow “Wallet” to access your location while you use the app?'),
                  content: new Text(
                      'Your location is used for things like showing relevant passes, card setup, and identifying store locations.'),
                  actions: <Widget>[
